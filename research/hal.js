...
var hals={
    ...
    function fetchPublications(target_id,group_key,docids){
            ...
            if(xmlhttp.readyState==4){
                if(xmlhttp.status==200){
                    ...
                    if (document.getElementById(target_id) != null) {
                        if(group_key!=''){
                            document.getElementById(target_id).innerHTML=formatPublicationsByGroup(hals[target_id],group_key);
                        }else{
                            document.getElementById(target_id).innerHTML=formatPublicationGroup(hals[target_id],group_key);
                        }
                    }
                }else{
    ...
    function formatPublicationGroup(docs,group_key){
        var s='';
    ...
    function formatPublicationsByGroup(docs,group_key){
        var s='';
        var doc_by_group={};
    ...
    function reformatPublicationByGroup(target_id,group_key){
        document.getElementById(target_id).innerHTML=formatPublicationsByGroup(hals[target_id],group_key);
    };
    jQuery(document).ready(function(){fetchPublications("publications","producedDateY_i",[]);});
