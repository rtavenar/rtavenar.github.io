...
var blacklist=[519490, 662905, 1254455, 916970, 1565586];
var idhal='rtavenar';
var num_paper=0;
...
var hals={
    ...
    jQuery(document).ready(function(){fetchPublications("ml_env","",[1515283, 1620604, 1343211, 1228397, 906292],"");});
    jQuery(document).ready(function(){fetchPublications("ml_ts","",[1622094,1561461,1339007,1357973,1321327,912512],"");});
